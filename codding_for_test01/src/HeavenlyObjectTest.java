...
public class HeavenlyObjectTest
{
	public static void main(String[] args)
	{
		...
		/*
		 * Have each object call all of its available getter methods and print out the
		...
		/*
		 * Have each object call its toString( ) method and print the results to the
		 * screen.
		 */
		...
		{
			int k = i + 1;
			System.out.println(heavenlyArray[i].getType() + " " + k + ":\n************\n findPerimeter: " + heavenlyArray[i].findPerimeter()
