/**
 * Filename: Planet.java Author: Yun-Jiung Wang Date: April 25, 2025 12:45:01 PM
...
the surface area of a planet by using a double formula surface
	 * area = 4* PI * radius2 Accepts: None Return: double
	 */
	@Override
	...
	/**
	 * Method: findSizeCategory Purpose: determines whether the planet is considered
	 * a small, medium, or large planet based on its surface area. Accepts: None
	 * Return: String
	 */
	@Override
	public String findSizeCategory()
	{
		...
		if (surfaceArea < 100000000)
		{
			categorySize = "small";
		}

		if (100000000 <= surfaceArea && surfaceArea <= 500000000)
		{
			categorySize = "medium";
		}

		if (surfaceArea > 500000000)
		{
			categorySize = "large";
		}
	...
	{
		return super.toString()+" it is "+ this.supportLife + " that this planet supports human life.";
	}
}
